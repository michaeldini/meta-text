...
class BookmarkService:
    def get_user_bookmark_for_metatext(self, session: Session, user_id: int, meta_text_id: int):
        ...
        bookmark = session.exec(
            ...
            .where(
                ...
                Chunk.meta_text_id == meta_text_id
            )
        ).first()
        return bookmark.chunk_id if bookmark else None

    def set_user_bookmark_for_metatext(self, session: Session, user_id: int, meta_text_id: int, chunk_id: int):
    ...
    def clear_user_bookmark_for_metatext(self, session: Session, user_id: int, meta_text_id: int):
