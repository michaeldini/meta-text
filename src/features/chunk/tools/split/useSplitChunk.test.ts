...
describe('useSplitChunk', () => {
    ...
    const mockProps: SplitChunkToolComponentProps = {
        chunkId: 1,
        chunk: mockChunk,
        chunkIdx: 0,
        word: 'test',
    ...
    it('should work with different chunk properties', async () => {
        ...
        const differentProps: SplitChunkToolComponentProps = {
            chunkId: 42,
            chunk: {
                ...mockChunk,
                id: 42,
    ...
    it('should handle edge case with zero indices', async () => {
        ...
        const edgeCaseProps: SplitChunkToolComponentProps = {
            chunkId: 1,
            chunk: mockChunk,
            chunkIdx: 0,
            word: 'This',
    ...
    it('should call onComplete callback if provided in props', async () => {
        ...
        const propsWithCallback: SplitChunkToolComponentProps = {
            ...mockProps,
